...
public class SensorController1 : MonoBehaviour
{
    ...
    //private BotController1 bc = default;
    private AtackMovement1 am = default;


    // Start is called once before the first execution of Update after the MonoBehaviour is created
    void Start()
    {
        //bc = transform.parent.GetComponent<BotController1>();
        am = transform.parent.GetComponent<AtackMovement1>();
    }
    ...
    private void OnTriggerStay(Collider other)
    {
        if (other.gameObject.CompareTag("Player"))
        {
            ...
            if (angle <= serchAngle)
            {
                ...
                {
                    //視野角内にいるかどうか(いた場合攻撃開始とPlayerの位置情報)
                    ...
                    //視野角内と半径内の距離の位置にPlayerがいたら攻撃開始とPlayerの位置情報
